...
*/
local int unzlocal_GetCurrentFileInfoInternal OF((unzFile
                                                         file,
        ...
        uLong commentBufferSize;
{
    ...
    if ((err == UNZ_OK) && (szFileName != NULL)) {
        ...
        if ((file_info.size_filename > 0) && (fileNameBufferSize > 0)) if (
                fread(szFileName, (uInt) uSizeRead, 1, s->file) != 1)
            err = UNZ_ERRNO;
        lSeek -= uSizeRead;
    }
    ...
    if ((err == UNZ_OK) && (extraField != NULL)) {
        ...
        if ((file_info.size_file_extra > 0) && (extraFieldBufferSize > 0)) if (
                fread(extraField, (uInt) uSizeRead, 1, s->file) != 1)
            err = UNZ_ERRNO;
    ...
    if ((err == UNZ_OK) && (szComment != NULL)) {
        ...
        if ((file_info.size_file_comment > 0) && (commentBufferSize > 0)) if (
                fread(szComment, (uInt) uSizeRead, 1, s->file) != 1)
            err = UNZ_ERRNO;
